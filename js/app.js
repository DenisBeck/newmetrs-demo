 ...
 */
    ...
    (() => {
        ...
        function formSubmit(options = {
            ...
            async function formSubmitAction(form, e) {
                ...
                if (0 === error) {
                    ...
                    if (ajax) {
                        e.preventDefault();
                        const formRedirect = form.classList.contains("receive-form") ? "result.html" : "receive.html";
                        ...
                        form.closest(".sending-form").classList.add("_sending");
                        ...
                        if (response.ok) {
                            ...
                            setTimeout((() => {
                                form.closest(".sending-form").classList.remove("_sending");
                                formSent(form, formRedirect, responseResult);
                            }), 3e3);
                        } else {
                            console.log("Ошибка");
                            setTimeout((() => {
            ...
            function formSent(form, formRedirect = ``, responseResult = ``) {
        ...
        const selectors = document.querySelectorAll(".receive-input__input_phone .input");
        ...
        function initSliders() {
            let swiper1, swiper2;
            if (document.querySelector(".form-page__form")) swiper1 = new core(".form-page__form", {
                ...
                pagination: {
                    type: "custom",
                    el: ".form-page__progress .progress__text",
                    clickable: false,
                    renderCustom: function(swiper, current, total) {
                        return `<div class="progress__text"><span>Шаг ${current} </span>из ${total}</div>`;
                    }
                },
                navigation: {
                    prevEl: ".submit__button_prev",
                    nextEl: ".submit__button_next"
                },
                on: {}
            });
            if (document.querySelector(".expert__slider")) swiper2 = new core(".expert__slider", {
                modules: [ Navigation, Pagination, EffectFade ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                pagination: {
                    type: "progressbar",
                    el: ".form-page__progress .progress__scale",
                    clickable: false
                },
                navigation: {
                    prevEl: ".submit__button_prev",
